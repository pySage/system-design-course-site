...
const lessonMeta = {
  ...
  "08-drill-order-and-mock-interview-prep": {
    ...
    goals: [
      ...
      "Translate internal 7+1/LGTC reasoning into standard requirements, entities, API, high-level design, and deep-dive language",
    ...
    takeaways: [
      ...
      "The course order is the thinking track; standard requirements, API, high-level design, and deep-dive sections are the spoken delivery track.",
